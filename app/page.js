  ...
  return (
    <div className="">
      ...
      <div className='flex flex-col items-center'>
        <p className='text-center font-extralight leading-1 text-xl'>Streamline tax management with real-time tracking, reports, and controls to optimize revenue and compliance
        <br/>across locations.</p>
