            ...
            <div className="home-navbar-color h-screen w-full max-w-xs">
              <div className={`py-4`}>
                ...
                <div className="flex flex-col mt-10 gap-3">
                  <div className={`flex flex-row items-center gap-3 cursor-pointer ${page === 1 ? "bg-gradient-to-b from-[#185FF6] to-[#1B45A6] py-3 px-6 text-white" : "bg-none px-6 py-3"}`}>
                  <Image className="bg-white p-2 rounded-md" src={signuplogo} alt="Signup Logo" height={30} width={30}/>
                  <h1 className="">Admin Signup</h1>
                </div>
                <div className={`flex flex-row items-center gap-3 cursor-pointer ${page === 2 ? "bg-gradient-to-b from-[#185FF6] to-[#1B45A6] py-3 px-6 text-white" : "bg-none px-6 py-3"}`}>
                  <Image className="bg-white p-2 rounded-md" src={signuplogo} alt="Signup Logo" height={30} width={30}/>
                  <h1 className="">Branch Details</h1>
                </div>
                <div className={`flex flex-row items-center gap-3 cursor-pointer ${page === 3 ? "bg-gradient-to-b from-[#185FF6] to-[#1B45A6] py-3 px-6 text-white" : "bg-none px-6 py-3"}`}>
                  <Image className="bg-white p-2 rounded-md" src={signuplogo} alt="Signup Logo" height={30} width={30}/>
