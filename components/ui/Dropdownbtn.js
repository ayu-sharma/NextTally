  ...
  return (
    <div className="relative inline-block text-right">
      <Menu>
        ...
        <MenuItems className="absolute right-0 w-52 origin-top-right rounded-xl border border-white/5 bg-gray-900 p-1 text-sm text-white shadow-lg transition duration-100 ease-out focus:outline-none">
