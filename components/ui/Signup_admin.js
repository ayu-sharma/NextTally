                    ...
                    <div className='flex-1 flex items-start flex-row w-full'>
                        <div className='bg-gradient-to-b from-[#185FF6] to-[#1B45A6] h-screen max-w-xl w-full flex flex-col justify-center items-center'>
                            ...
                            <div className='text-white font-normal text-md text-center px-5'>
                                Streamline tax management across locations with our unified platform. Enjoy real-time tracking, comprehensive reporting, and robust control to optimize revenue and boost profitability.
                            </div>
                            <div>
                        ...
                        <div className='flex flex-col w-full pt-24 px-20'>
                            ...
                            <div className='pt-6 w-full flex flex-col'>
                                <input type='text' placeholder='Name' className='border-2 border-gray-300 rounded-md py-2.5 px-6 w-full mt-1 text-xs' />

                                <input type='email' placeholder='Email Address' className='border-2 border-gray-300 rounded-md py-2.5 px-6 w-full text-xs mt-4' />

                                <input type='password' placeholder='Password' className='border-2 border-gray-300 rounded-md py-2.5 px-6 w-full mt-4 text-xs' />

                                <input type='password' placeholder='Confirm Password' className='border-2 border-gray-300 rounded-md py-2.5 px-6 w-full text-xs mt-4' />
